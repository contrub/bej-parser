...
/**
 * @brief Universal test function for a JSON → BEJ → JSON round-trip.
 *
 * @param json_path Path to the JSON file.
 * @param schema_path Path to the binary schema dictionary.
 * @param annot_path Path to the binary annotation file (can be empty).
 */
